...
export default function InfoGalery() {
  ...
  const titleInViewPort = useIntersection(titleRef);
  // useEffect(() => {
  //   if (titleInViewPort) {
      ...
      <div className="mt-4 pb-24 lg:flex-1 ">
        <div className="relative h-24 sm:h-32 animate-down-to-top">
          <div className="bg-[#DBDADA] rounded-lg w-4/6 h-[72px] z-20 absolute left-0 top-0 sm:bottom-16 sm:w-3/6 lg:sm:w-[120%] ">
            <h1
              ref={titleRef}
              className="text-[#4D4D4D] font-bold text-xl text-justify p-5  underline  underline-offset-8 sm:text-[20px] lg:text-[29px]"
            >
              Runnig and Walking
            </h1>
          </div>
        </div>
        <p className="text-lg text-[#DBDADA] text-justify leading-[24px] font-normal sm:text-[32px] sm:leading-[39px]   animate-down-to-top ">
